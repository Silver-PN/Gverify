...
import '../ekyc/widget/info_ekyc_row.dart';
import '../widgets/custom_button.dart';


class OcrResultEkycView extends StatelessWidget {
  bool? needPadding;
  OcrResultEkycView({this.needPadding,super.key});
        ...
        child: Container(
          ...
          child: Column(
            children: [
                ...
                child: Column(
                  children: [
                    ...
                    (OnboardManager.instance.isAuthCard() == true &&
                        OnboardManager.instance.verificationStatus?.isValidIdCard == true &&
                    ...
                    child: Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          InfoEkycRow(
                            title: "Xác thực CCCD",
                            isSuccess: OnboardManager.instance.verificationStatus?.isValidIdCard,
                          ),
                          InfoEkycRow(
                              title: "Face Matching",
              ...
              Padding(padding: const EdgeInsets.symmetric(horizontal: 10), child: CustomButton(onPressed: (){Navigator.popUntil(context, (route) => route.isFirst);}, content: "XONG"),)
            ],
          ),
        ));
  }
