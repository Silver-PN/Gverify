...
class OcrInfoResultRow extends StatelessWidget {
  String title;
  String content;

  OcrInfoResultRow({super.key, required this.title, required this.content});
        ...
        Row(
          ...
          children: [
            SizedBox(
              ...
              child: Text(
                title,
                style:  mediumTextStyle(15, BrandColors.silver),
              ),
            ),
            Expanded(
              child: Text(
